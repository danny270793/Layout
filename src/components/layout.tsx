...
export function Header(props: HeaderProps): ReactNode {
    return (
        <div className={`ios-safe-top sticky top-0 left-0 right-0 ${props.className}`}>
            <div className="ios-safe-left ios-safe-right">
                {props.children}
            </div>
        </div>
    )
...
export function Footer(props: FooterProps): ReactNode {
    return (
        <div className={`ios-safe-bottom sticky bottom-0 left-0 right-0 ${props.className}`}>
            <div className="ios-safe-left ios-safe-right">
                {props.children}
            </div>
        </div>
